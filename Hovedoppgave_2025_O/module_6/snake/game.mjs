...
export function newGame() {
  ...
  GameProps.menu.resetScore();
  clearInterval(hndUpdateGame); //resette gameSpeed på slangen, fikk hjelp i lab til dette.
