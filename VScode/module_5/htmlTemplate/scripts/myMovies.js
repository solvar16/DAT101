...
export class TMyMovies extends TBootstrapComponent {
  ...
  constructor(){
    ...
    //Hvis vi har filmer i localeStorage, så henter vi disse
  ...
  #loadMovies(){
    ...
    //vi må tømme tabellen for vi legger til rader
...
class TMovieForm extends TBootstrapComponent {
  ...
  #onSubmitForm = (aEvent) => {
    ...
    for(let i = 0; i < this.#genreElements.length; i ++){
        //Oppgave; legge til kun de valgte sjangerne!
  ...
  render(){
    ...
    if(editMovie){
        //her må vi fylle ut feltene med informasjonen fra editMovie
