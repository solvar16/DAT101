...
export const GameProps = {
  ...
  score: 0,
  bestScore: 0,
  sounds: {countDown: null, food: null, gameOver: null, dead: null, flap: null, running: null},
...
function animateGame() {
  switch (GameProps.status) {
    ...
    case EGameStatus.gameOver:
      ...
      if (delBaitIndex >= 0) { //spiser en sommerfugl
        GameProps.baits.splice(delBaitIndex, 1);
        GameProps.menu.incScore(10)
        GameProps.sounds.food.play(); //spiller av lyd når den spiser sommerfugl.
      }
      break;
...
export function startGame() {
  ...
  spawnObstacle(); //henter inn flere objekter
  spawnBait();
  //spill av lyd
